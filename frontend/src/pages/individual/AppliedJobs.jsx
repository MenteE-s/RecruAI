      ...
      <DashboardLayout sidebarItems={sidebarItems}>
        <div className="space-y-4 mt-6">
          ...
          <div className="bg-white border border-gray-200 p-4">
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white border border-gray-200 p-5 animate-pulse mb-2">
    ...
    <DashboardLayout sidebarItems={sidebarItems}>
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4 mt-6">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-500 shrink-0">
          ...
          <span>{filtered.length} of {appliedJobs.length}</span>
          {(search || statusFilter) && (
            <button onClick={() => { setSearch(""); setStatusFilter(""); }} className="text-blue-600 hover:text-blue-700 font-medium ml-1">Clear</button>
          )}
        </div>
      </div>
