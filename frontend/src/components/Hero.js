  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 pt-20 pb-16 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-32 h-32 bg-gradient-to-r from-accent-400 to-primary-600 rounded-lg opacity-15 animate-float transform rotate-45" style={{animationDelay: '1s'}}></div>
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center w-full">
            ...
            <div className={`transition-all duration-1000 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
              ...
              <h1 className="text-4xl tracking-tight font-display font-bold text-secondary-900 sm:text-7xl md:text-8xl lg:text-7xl xl:text-7xl">
                ...
                <span className="block animate-fade-in-up" style={{animationDelay: '0.4s'}}>
                  with <span className="bg-gradient-to-r from-accent-600 to-primary-600 bg-clip-text text-transparent">RecruAI</span>
                </span>
              </h1>
          ...
          <div className="mt-16 lg:mt-0 lg:col-span-6 relative">
            <div className="relative animate-fade-in-up" style={{animationDelay: '0.5s'}}>
              ...
              <div className="relative z-10 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl animate-float">
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center justify-center w-24 h-24 bg-gradient-to-r from-primary-500 to-accent-500 rounded-2xl mx-auto mb-6 animate-pulse-glow">
                    <svg className="w-12 h-12 text-white animate-bounce-slow" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className="text-center">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-center">
                      ...
                      <div className="animate-scale-in" style={{animationDelay: '1.4s'}}>
                        <div className="text-2xl font-bold text-success-600">500+</div>
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 border border-accent-200/20 rounded-full animate-spin-slow" style={{animationDirection: 'reverse', animationDuration: '20s'}}></div>
            </div>
          </div>
        </div>
      </div>
